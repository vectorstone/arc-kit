class ArcKit < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vectorstone/arc-kit/releases/download/v2026.5.14/arc-kit-aarch64-apple-darwin.tar.gz"
      sha256 "52863b171d6d124ef3c37d0c1b53594b4b64e7d1e731fb2a6422b36b174a31a9"
    end

    on_intel do
      url "https://github.com/vectorstone/arc-kit/releases/download/v2026.5.14/arc-kit-x86_64-apple-darwin.tar.gz"
